...
/**
 * Created by luannb on 12/25/2015.
 */
public class Config {
    public static final String app_id = "8f6b6d607b7b6f5ec45b367c1c97ca68";
    ...
    public static String[] listFriendName = {"VStack 1", "VStack 2", "VStack 3", "VStack 4", "VStack 5",
            "VStack 6"};
    public static String[] listFriendVStackUserId = {"vstack1", "vstack2", "vstack3", "vstack4",
            "vstack5", "vstack6"};
}
